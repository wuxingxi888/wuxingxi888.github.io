---
title: 前端 AI Coding 落地指南（二）Rules篇
date: 2026-02-07 17:27:35
tags: 前端 AI编程
categories: 其他
top_img: https://cdn.jsdelivr.net/gh/wuxingxi888/CDN_IMG_BED/ai_coding_2.webp
cover: https://cdn.jsdelivr.net/gh/wuxingxi888/CDN_IMG_BED/ai_coding_2.webp
---

> 本架构示例项目：[AI Coding Guidelines](https://github.com/wuxingxi888/ai-coding-guidelines)

> 原文链接（掘金）：[前端 AI Coding 落地指南（二）Rules篇](https://juejin.cn/post/7603444191448104994)
>
...
**最近：Skills 盛行，Rules 简化 + 实施指导迁到 Skills**  
 引入 Skills 之后，做了两件事：**Rules 只保留「原则与约束」**（做什么、不做什么、目录/命名/契约），**把「如何一步步做、怎么写示例、产出长什么样」迁到 Skills**，并利用 Skills 的**渐进式披露**（只在执行该任务时加载对应 SKILL 和技能内 rules）。这样 Rules 变薄、按需读；具体落地在 Skills 里按场景加载，既避免上下文爆炸，又避免模型在长文档里「抓不住重点」。**Skills 的详细实践、何时封装、技能下 rules 如何拆分见[《前端 AI Coding 落地指南（三）Skills 篇》](https://juejin.cn/post/7603347438013497379)。**
...
以上就是项目级 Rules 的完整清单与通用化示例。项目级 Skills 的逐条示例在[《前端 AI Coding 落地指南（三）Skills 篇》](https://wuxingxi.top/2026/02/08/%E5%89%8D%E7%AB%AF%20AI%20Coding%20%E8%90%BD%E5%9C%B0%E6%8C%87%E5%8D%97%EF%BC%88%E4%B8%89%EF%BC%89Skills%E7%AF%87/)；[架构篇](https://wuxingxi.top/2026/02/07/%E5%89%8D%E7%AB%AF%20AI%20Coding%20%E8%90%BD%E5%9C%B0%E6%8C%87%E5%8D%97%EF%BC%88%E4%BA%8C%EF%BC%89Rules%E7%AF%87/)、Rules 篇、Skills 篇一起构成从架构到 Rules/Skills 落地的完整指南。
